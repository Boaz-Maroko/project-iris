...
def plot_for_tk(data, parent):
    """
    Takes the clustered data and draws it to fit into tkinter
    parameters:
    data: pandas.DataFrame, parent: tkinter parent widget
    """

    pairplot = sns.pairplot(data, hue="cluster", markers=["o", "s", "D"])
